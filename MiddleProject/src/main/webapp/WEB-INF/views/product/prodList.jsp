			...
			<div class="container">
				...
				<div class="row mb-5">
					...
					<div class="col-md-3 order-1 mb-5 mb-md-0">
						...
						<div class="border p-4 rounded mb-4">
							<div class="mb-4" onclick="subcategory()">
								<h3 class="mb-3 h6 text-uppercase text-black d-block"
									class="jquery-on-container">
									<a class="js-open-target" id="subcat"
										data-target=".closed-content2">세부카테고리</a>
								</h3>
								<div class="closed-content2">
						...
						<div class="border p-4 rounded mb-4">
							<div class="mb-4">
								...
								<c:forEach var="i" begin="0" end="${fn:length(genderlist)-1}">
									<label for="${genderlist[i].genderId}" class="d-flex">
										<input type="checkbox" id="${genderlist[i].genderId}"
