...
<form method="post" id="form">
  ...
  <dl class="row" id="b">
    ...
    <dd class="col-sm-9"><input type="text" id="price" name="price" value="${price.buyPrice}원" readonly></dd>
  </dl>
  <hr />
  <dl class="row">
...
<script>
  ...
  function insertPrice(){
  	...
  	if(Number(inputPrice) <= Number('${price.buyPrice}') && Number(inputPrice)>0){
  		test1();
  	}else{
  		  price = inputPrice;
  		  calcul(price);
