			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="main.do">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">ModifyInfo</strong>
					</div>
				</div>
			</div>
		</div>
							...
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row text-center">
									<div class="col-md-6 text-center mt-3">
										<input type="submit" class="btn btn-success btn-lg btn-block" value="완료">
									</div>
								</div>
							</div>
						</form>
