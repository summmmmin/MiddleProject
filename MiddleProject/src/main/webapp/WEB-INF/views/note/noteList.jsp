...
<table class="table table-striped" style="width:1000px;">
  <thead>
    <tr>
      ...
      <th><button type="button" onclick="location.href='delAllNote.do?noteId=${userinfo.userId}&page=${pageInfo.pageNum}'" class="btn btn-danger btn-sm4">전체삭제</button></th>
    </tr>
  </thead>
  ...
  <c:when test ="${i.noteViews > 0}">
    <tr style="opacity:0.5;">
		...
		<td class="d-inline-block text-truncate" style="max-width: 800px;"><a href="getNote.do?page=${pageInfo.pageNum}&noteId=${i.noteId }" class="td1 col-2 text-truncate">${i.noteCT }</a></td>
		<td >${i.noteDate}</td>
